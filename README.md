...
The intended usage is to export by specifying the domain basis, so that objects are output without losing their attributes. When importing, three major strategies are expected;
